		<div class="container-center">
			...
			<header class="entry-header container-fluid">
				...
				<h1 class="black-text condensed-bold small-heading top-buffer-padding bottom-buffer-padding col-xs-12 col-sm-4">
				...
				<?php if (is_page('about-us')||is_parent_slug() == 'about-us'): ?>
					<div class="col-sm-8 top-buffer-padding bottom-buffer-padding">
					<?php
                    wp_nav_menu(
                        array(
                        'container'  => 'div',
