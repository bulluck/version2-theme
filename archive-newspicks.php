			...
			<div class="row">
				<div class="col-xs-12">
					...
					<a href="<?php echo home_url('/');?>news/">
						<h2 class="large-heading redtext condensed-bold">News</h2>
					</a>
					<p class="small-text top-buffer-padding">
						マーケティングに関する最新情報をお届けします。
						<a class="redtext" href="<?php echo home_url('/');?>news/">マーケティングに関する記事を読む<i class="fa fa-chevron-right" style="padding-left:10px;"></i></a>
					</p>
				</div>
			</div>
			<div class="row">
