...
<!--ツイートボタン-->
<li class="twitter top-buffer col-xs-6 col-sm-3">
...
<!--Facebookボタン-->
<li class="facebook top-buffer col-xs-6 col-sm-3">
...
<!--Google+1ボタン-->
<li class="googleplus top-buffer col-xs-6 col-sm-3">
...
<!--ポケットボタン-->
<li class="pocket top-buffer col-xs-6 col-sm-3">
<a href="http://getpocket.com/edit?url=<?php echo $url_encode;?>&title=<?php echo $title_encode;?>" class="btn btn-sm" target="blank">pocket&nbsp;
