              ...
              <div class="col-xs-12 clip-board purewhitebg top-buffer-padding bottom-buffer-padding">
                ...
                <div class="row">
                  <div class="col-xs-12">
                      ...
                      <div class="col-xs-12 col-sm-9 top-buffer">
                        <p class="smaller-p">
                          通常の制作会社では、クライアント様が依頼したランディングページをデザイナー、エンジニアが言われた通りに作るだけです。デザイナー、エンジニアは、経営や投資対効果、マーケティングに関することは当然専門外であるので、クライアント様に言われた通りのものを作ります。したがって、売り上げがどうなろうと、受注率がどうなろうと知る由もありません。ここにランディングページ制作における大きな落とし穴があると考えています。
                        </p>
                      </div>
                    </div>
                </div>
