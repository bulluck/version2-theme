      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6">
          ...
          <div class="col-xs-12 col-sm-12 purewhitebg top-buffer-padding bottom-buffer-padding">
            ...
            <p class="small-text top-buffer">
              お問い合わせいただきましたら、具体的なご要望をしっかりとヒアリングさせていただきます。日本全国47都道府県、お電話にて対応しております。皆様にはお電話でも不足なく対応させていただいておリます。出張打ち合わせもございます。詳細はお問い合わせください。
            </p>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6 top-buffer">
          ...
          <div class="col-xs-12 col-sm-12 purewhitebg top-buffer-padding bottom-buffer-padding">
            ...
            <p class="small-text top-buffer">
              ターゲティングの選定、戦略の立案が完了しましたら、ニーズに合わせて戦略的なデザインを行っていきます。
              ファーストビューのデザイン・ボタンの配色などでもコンバージョン率が圧倒的に変わります。そのため、ブラックのデザイナーはただキレイなだけではなく、売り上げが上がる効果的なデザインを意識した制作を経営コンサルタント共に行います。
            </p>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6 top-buffer">
          ...
          <div class="col-xs-12 col-sm-12 purewhitebg top-buffer-padding bottom-buffer-padding">
            ...
            <p class="small-text top-buffer">
              完成した後の運用が最も重要です。日々の運用・改善を行いPDCAサイクルを最速で回していきます（運用をご依頼の場合）。アナリティクス解析、Webマスターツール分析、ABテスト分析等をブラックの経営コンサルタントが一社一社行い、より効果的なランディングページに仕上げていきます。皆様には意思決定だけしていただければ、ブラックが圧倒的な結果をご提供いたします。
            </p>
          </div>
        </div>
