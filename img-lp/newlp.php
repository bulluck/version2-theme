<article class="lp-wrapper purewhitebg">
  ...
  <section class="section-padding80 trouble">
    <div class="container-center">
      <div class="container-fluid">
        <div class="row">
          <div class="col-xs-12">
            <div class="lp-table">
              <div class="lp-tablecell" id="trouble">
                <h2 class="medium-heading border-top-bottom top-buffer-padding bottom-buffer-padding agreespan heading-circle">
                  こんなお悩みありませんか？
                </h2>
              </div>
            </div>
    ...
    <i class="fa fa-chevron-down fa-5x seedown"></i>
  </section>
          ...
          <div class="col-xs-12 col-sm-6">
            ...
            <div class="col-xs-12 col-sm-12 clip-board">
                ...
                <div class="row purewhitebg bottom-buffer-padding">
                  <div class="col-xs-12">
                    <div class="col-xs-12 col-sm-12">
                      <img src="http://bulluck.co.jp/version2/wp-content/themes/version2-theme/images/onese-mihon.png" alt="ランディングページ事例3" class="worksimg" />
                    </div>
                    <div class="col-xs-12 col-sm-12 top-buffer">
                        <p class="tagred white-text align-center">背景</p>
                        <p class="smaller-p top-buffer height-fixed-kadai">
                          自社ホームページとランディングページを新規で両方を安価に作りたいというご要望がありました。
                          また、今後絵画などのアーティスティックな商品も販売したいきたいとのことで、デザイン性にも優れたこだわりのあるサイトをお作りしたいとのことでした。
                        </p>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-xs-12" id="reason">
            <h2 class="medium-heading agreespan border-top-bottom bottom-buffer-padding top-buffer-padding heading-circle good-reason sp-br">他社との圧倒的な違い</h2>
          </div>
        </div>
          <div class="row">
              ...
              <div class="col-xs-12 clip-board purewhitebg top-buffer-padding bottom-buffer-padding">
                ...
                <div class="row">
                  <div class="col-xs-12">
                      ...
                      <div class="col-xs-12 col-sm-9 top-buffer">
                        <p class="smaller-p">
                          通常の制作会社では、クライアント様が依頼したランディングページをデザイナー、エンジニアが言われた通りに作る場合がほとんどです。デザイナー、エンジニアは、経営や投資対効果、マーケティングに関することは当然専門外であるので、クライアント様に言われた通りのものを作ります。したがって、売り上げがどうなろうと、受注率がどうなろうと知る由もありません。ここにランディングページ制作における大きな落とし穴があると考えています。
                        </p>
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-9 top-buffer">
                      <p class="smaller-p">
                      マーケティングに詳しいクライアント様であれば、依頼された通りのものを作るだけでも問題ありませんが、制作に関する知識、マーケティングに関する知識を持ち合わせたクライアント様は少ない印象を受けます。どうしても、売り上げ、受注率よりもデザインに偏りがちになってしまします。売れるランディングページは自我の表現から生まれるものではなく、市場の顧客属性、思考性、競合性から慎重に逆算することによってようやく作り出すことができます。
                      </p>
                    </div>
                </div>
                </div>
                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 col-sm-9 top-buffer">
                      <p class="smaller-p">
                          そこで、Web戦略室の実績のある経営コンサルタントが、戦略的なデザイン、戦略的なランディングページをデザイナー、エンジニアと連携しながら一つ一つ設計し、より売り上げに貢献できるような商品をお作りいたします。経営コンサルティングのノウハウを制作時に詰め込むことで、低コストで効果の高いランディングページを制作することができます。これが皆様に選ばれている理由の一つです。
                      </p>
                    </div>
                </div>
                </div>
              ...
              <div class="col-xs-12 lighter-dark-bg top-buffer-padding bottom-buffer-padding">
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-7">
                    ...
                    <p class="smaller-p top-buffer">
                      わが社の資産は、人材、資本及び信用から成ります。これらのいづれをも欠くことはできませんが、とりわけ構成要素の一つである”信用”は、ひとたび逸すれば、この回復は極めて困難です。
                      したがって、我々は、法律、規則及び道義の字義と精神を固く尊守することを自らに課しています。我々のさらなる成功は、この規範を忠実に守ることにかかっていると信じています。
                    </p>
                    <p class="smaller-p top-buffer">
                      また、我々は、我々が従事するあらゆる業務において最高の結果を得るために、不退転の決意でビジネスに望んでいます。
                      わが社の業務が多岐にわたり、取扱量が大幅に増加する場合であっても、規模において最大であるよりも質において最良であることが我々の選択であることを従業員一同共有しています。私が全責任を負って最高の商品をご提供いたします。
                    </p>
                  </div>
              </div>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 margin-t80">
            <div class="col-xs-12 col-sm-12 purewhitebg">
              <dl class="faq-dl">
              <dt class="top-buffer">日本全国対応していただけるのですか？</dt>
                <dd>日本語が通じればどこでも対応可能です。お電話やスカイプ（テレビ電話）、メールやラインをこまめに使うことで、ご対面するよりも頻度や密度が上がるため、効率的に制作、運用のご報告をすることができます。ご対面の打ち合わせも別途ご用意しております。詳しくはお問い合わせください。</dd>
                <dt class="top-buffer">どうしてそんなに安いのですか？</dt>
                <dd>制作段階で、経営コンサルティングのノウハウを詰め込むことができるからです。無駄な作業をそぎ落とすことで、集客の効果を高く保ったまま、お安く商品をご提供できます。</dd>
                <dt class="top-buffer">申し込みから納品まではどれくらいかかりますか？</dt>
                <dd>Web戦略室では、最短14日で納品いたします。ただし、お申込み状況等により、変動する場合もございます。お急ぎの方は、お問い合わせの際にその旨ご相談いただけると幸いです。</dd>
                ...
                <dd>サーバーとドメインを自社で取得済みの会社様は、管理費から月額1000円分を差し引いたお値段でご利用いただけます。</dd>
                ...
                <dd>基本的には、ご希望のイメージ、参考となるランディングページをお伝えいただき、こちらで戦略を立てて制作いたします。万が一、ご希望に沿わなかった場合は、ご納得いただけるまで修正いたしますのでご安心頂ければと思います。</dd>
