      ...
      <div class="s-table-cell container-fluid">
        ...
        <div class="row">
            ...
            <p class="small-text col-xs-12 top-buffer">
              ブラックのサイト、ランディングページ制作は品質が違います。ターゲットに合わせたデザイン性、キャッチコピーなどのマーケティング的要素、進んだテクノロジーにより、圧倒的な品質と実績を誇っています。それでいて費用対効果が良いわけですから、選ばない理由はありません。
            </p>
        </div>
    </div>
    </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 top-buffer">
            <img class="worksimg" alt="works1" src="http://bulluck.co.jp/version2/wp-content/uploads/2015/11/0d7ea804aa3d68a7bff2f6b06e4dd3231.jpg">
        </div>
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 top-buffer">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <p class="small-text col-xs-12 top-buffer">
                情報の格差が富の格差へ直結しています。特に情報が溢れる時代、厳選されかつ、有益な情報を手にするのは容易ではありません。ブラックメディアの情報は、キュレーションと独自に制作された記事が合わさって配信されています。ビジネスを行う皆様にとって有益な情報を配信いたします。
              </p>
          </div>
        </div>
    </div>
