...
while (have_posts()) :
    the_post(); ?>
                            ...
                            <div class="col-xs-12 col-sm-6 mt-50 mb-50 pr-0 pl-0">
...
(adsbygoogle = window.adsbygoogle || []).push({});
                            ...
                            <div class="col-xs-12 col-sm-6 mt-50 mb-50 hidden-xs pl-5 pr-0">
                            <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
                            <!-- ブラックメディア広告 -->
                            <ins class="adsbygoogle"
                            style="display:block"
...
?>
                    ...
                    <aside class="col-xs-12 col-sm-4 pt-30 col-sm-pull-8 pr-10 pl-10">
